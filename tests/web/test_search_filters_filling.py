...
@allure.feature("Поисковые фильтры на главной странице")
@allure.story("Проверка заполнения поисковых фильтров на главной странице")
class TestSearchFiltersFilling:
    ...
    def test_buy_realty_tab_filters(self):
        ...
        with allure.step("Проверить, что фильтры заполнены корректно"):
            self.main_page.should_buy_realty_filters_have_text('Дом, дачу', '7 - 9 млн', 'Краснодарский край, Сочи')


    @allure.tag("web")
    @allure.severity(Severity.NORMAL)
    @allure.label("owner", "kyarygina")
    def test_rent_realty_tab_filters(self):
        ...
        with allure.step("Проверить, что фильтры заполнены корректно"):
            self.main_page.should_rent_realty_filters_have_text('Квартиру', '1, 2 комн.', '20 - 30 тыс', 'Краснодар')


    @allure.tag("web")
    @allure.severity(Severity.NORMAL)
    @allure.label("owner", "kyarygina")
    def test_daily_rent_realty_tab_filters(self):
        ...
        with allure.step("Проверить, что фильтры заполнены корректно"):
            self.main_page.should_daily_rent_realty_filters_have_text('Калининград')


    @allure.tag("web")
    @allure.severity(Severity.NORMAL)
    @allure.label("owner", "kyarygina")
    def test_mortgage_realty_tab_filters(self):
        ...
        with allure.step("Проверить, что фильтры заполнены корректно"):
            self.main_page.should_mortgage_realty_filters_have_text('Квартира в новостройке', '9 000 000', '3 000 000', '20 лет')


    @allure.tag("web")
    @allure.severity(Severity.NORMAL)
    @allure.label("owner", "kyarygina")
    def test_realtor_realty_tab_filters(self):
        ...
        with allure.step("Проверить, что открыто окно с заголовком 'С чем нужна помощь риелтора?'"):
            self.main_page.should_header_have_text('С чем нужна помощь риелтора?')